...
while True:
	...
	lmList, lmList2 = detector.findPosition(img)
	#
	# movement = int(lmList[4][1]*screen_height)
	#
	if len(lmList) != 0:
		if lmList[4][1] > 0.5:
			player.rect.y = int(lmList[4][2]*screen_height)
		else:
			opponent.rect.y = int(lmList[4][2]*screen_height)
